...
def class_names_fun(data_dir):
    ...
    print("---from---class_names_fun----class_names: ", class_names)
    return class_names


def plot_training_results(train_loss_list, valid_loss_list, valid_accuracy_list, epoch_num_save_chart):
    """
    ...
    Output: None
    """
    print("----plot_training_results--->>--epoch_num_save_chart-----",epoch_num_save_chart)
    epoch_num = epoch_num_save_chart
...
def main(args):
    ...
    print("------type--transforms----",type(transform))
    ...
    if not args["model"]:
        print("---In Here ---got no input for model - training a new model")
        # Defining the model
        model_path = os.path.abspath("model")
        print("---model_path---- training a new model",model_path)

        # Train the network
        print("-----Model in TRAIN MODE --again done model.cuda()---")
        model.cuda()
        ...
        plot_training_results(train_loss_list, valid_loss_list,valid_accuracy_list, epoch_num_save_chart)
